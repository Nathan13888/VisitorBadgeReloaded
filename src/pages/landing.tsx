        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
              <a
                href="https://github.com/Nathan13888/VisitorBadgeReloaded"
                target="_blank"
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div class="text-center">
          ...
          <p class="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto">
            A high-performance, fully customizable visitor badge service built
            on Cloudflare Workers. Add beautiful visitor counters to your GitHub
            profile or website in seconds.
          </p>
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <a
              href="#quickstart"
              class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all"
            >
              Get Started
            </a>
            <a
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center p-6">
            ...
            <p class="text-slate-600 dark:text-slate-300">
              Built on Cloudflare Workers for edge performance worldwide
            </p>
          </div>
          <div class="text-center p-6">
            ...
            <p class="text-slate-600 dark:text-slate-300">
              Colors, styles, logos, and text - make it yours
            </p>
          </div>
          <div class="text-center p-6">
            ...
            <p class="text-slate-600 dark:text-slate-300">
              Free, transparent, and self-hostable
            </p>
          </div>
        </div>
      </section>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
            <div class="flex items-start space-x-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-slate-600 dark:text-slate-300 mb-4">
                  Track detailed visitor analytics for your badge:
                </p>
                <div class="bg-slate-100 dark:bg-slate-900 rounded-lg p-4 font-mono text-sm overflow-x-auto mb-4">
                  <code class="text-slate-800 dark:text-slate-200">
                    https://vbr.nathanchung.dev/info/YOUR_ID
                  </code>
                </div>
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                  <p class="text-sm text-blue-800 dark:text-blue-200">
                    📊 View hourly/daily trends, top referrers, geographic data,
                    and unique visitors for the last 14 days
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="space-y-6">
            <div class="border-b border-slate-200 dark:border-slate-700 pb-6">
              ...
              <div class="flex flex-wrap gap-3">
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&style=flat&hit=false"
                  alt="Flat style"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&style=flat-square&hit=false"
                  alt="Flat square style"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&style=for-the-badge&hit=false"
                  alt="For the badge style"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&style=plastic&hit=false"
                  alt="Plastic style"
                />
              </div>
            </div>
            <div class="border-b border-slate-200 dark:border-slate-700 pb-6">
              ...
              <div class="flex flex-wrap gap-3">
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&color=55acb7&style=for-the-badge&hit=false"
                  alt="Blue badge"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&color=ff4d6d&style=for-the-badge&hit=false"
                  alt="Red badge"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&color=06d6a0&style=for-the-badge&hit=false"
                  alt="Green badge"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&color=ffd166&style=for-the-badge&hit=false"
                  alt="Yellow badge"
                />
              </div>
            </div>
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&logo=Github&style=for-the-badge&hit=false"
                  alt="GitHub logo"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&logo=GitLab&color=FCA121&style=for-the-badge&hit=false"
                  alt="GitLab logo"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&logo=Twitter&color=1DA1F2&style=for-the-badge&hit=false"
                  alt="Twitter logo"
                />
                <img
                  src="https://vbr.nathanchung.dev/badge?page_id=demo&logo=YouTube&color=FF0000&style=for-the-badge&hit=false"
                  alt="YouTube logo"
                />
              </div>
            </div>
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-2xl p-8 sm:p-12 text-center">
          ...
          <p class="text-blue-100 mb-8 max-w-2xl mx-auto">
            Check out our documentation for advanced configuration options and
            self-hosting instructions.
          </p>
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="https://github.com/Nathan13888/VisitorBadgeReloaded#readme"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/Nathan13888/VisitorBadgeReloaded/issues"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div class="flex flex-col sm:flex-row items-center justify-between">
            <p class="text-slate-600 dark:text-slate-400 text-sm mb-4 sm:mb-0">
              Built with ❤️ by{" "}
              <a
                href="https://github.com/Nathan13888"
                target="_blank"
                rel="noopener noreferrer"
